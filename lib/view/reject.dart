...
class Service extends StatefulWidget {
  final bool showRejectSheet;

  const Service({super.key, this.showRejectSheet = false});
...
class _ServiceState extends State<Service> {
  ...
  void initState() {
    super.initState();
    // Open bottom sheet after the first frame is rendered
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (widget.showRejectSheet) {
    ...
    Get.bottomSheet(
      Container(
        ...
        child: Column(
          ...
          children: [
            Text("Reason for Rejection", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
            SizedBox(height: 10),
            TextField(
              ...
              children: [
                ...
                Expanded(
                  child: ElevatedButton(
                    onPressed: () {
                      Get.back(); // Close Bottom Sheet
                      Get.snackbar("Rejected", "Service request has been rejected.");
                    },
